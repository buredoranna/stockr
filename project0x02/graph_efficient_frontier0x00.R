...
require(stockPortfolio) # Base package for retrieving returns
require(ggplot2) # Used to graph efficient frontier
require(reshape2) # Used to melt the data
require(quadprog) #Needed for solve.QP
...
returns <- getReturns(names(stocks), freq="week") #Currently, drop index
